...
let package = Package(
    ...
    products: [.library(name: "BbAppViewPost", targets: ["BbAppViewPost"])],
    dependencies: [
    ...
    targets: [
        .binaryTarget(
            name: "BbAppViewPost",
            url:
                "https://github.com/thebbapp/swift-package-bb-app-view-post/releases/download/v0.1.0/BbAppViewPost.xcframework.zip",
            checksum: "171fcc1e1e6c71f9ca41bd5a07635b4b364eba814497b128c3632b2558076ee3"
        )
    ],
